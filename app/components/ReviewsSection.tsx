      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-center">
            <span className="text-[64px] font-bold text-white leading-none tracking-tighter">4.9</span>
      ...
      <div className="flex overflow-x-auto gap-4 scrollbar-hide snap-x pb-4">
        ...
        <div className="flex-none w-[320px] md:w-[380px] bg-[#222224] rounded-2xl p-5 snap-center flex flex-col justify-start">
          <div className="flex justify-between items-start mb-1">
            <span className="text-[15px] font-bold text-white leading-tight">Amazing Developer</span>
            <span className="text-[13px] text-gray-500">02/14/2026</span>
          </div>
          <div className="flex justify-between items-center mb-3">
            <div className="flex text-[#ff8c00] gap-0.5">
              {Array.from({length: 5}).map((_, i) => <svg key={`s1-${i}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5"><path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z" clipRule="evenodd" /></svg>)}
            </div>
            <span className="text-[13px] text-gray-500">Client142</span>
          </div>
          <p className="text-[14px] leading-[1.4] text-[#e5e5e5]">
            Update, I posted the review below the line, and Kartikay's delivery exceeded expectations. I'm a fan of that commitment to the users. I really appreciate the level of service and communication, so if you want to elevate your product... <span className="text-[#1e86ff] cursor-pointer">more</span>
          </p>
        </div>
        ...
        <div className="flex-none w-[320px] md:w-[380px] bg-[#222224] rounded-2xl p-5 snap-center flex flex-col justify-start">
          <div className="flex justify-between items-start mb-1">
            <span className="text-[15px] font-bold text-white leading-tight">Flawless execution</span>
            <span className="text-[13px] text-gray-500">04/03/2025</span>
          </div>
          <div className="flex justify-between items-center mb-3">
            <div className="flex text-[#ff8c00] gap-0.5">
              {Array.from({length: 5}).map((_, i) => <svg key={`s2-${i}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5"><path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z" clipRule="evenodd" /></svg>)}
            </div>
            <span className="text-[13px] text-gray-500">DesignMonster</span>
          </div>
          <p className="text-[14px] leading-[1.4] text-[#e5e5e5]">
            In the app, I find a wide variety of attention to detail and animations that work smoothly. The responsiveness is unmatched and the implementation matches the original Figma designs pixel-by-pixel. Extremely satisfied... <span className="text-[#1e86ff] cursor-pointer">more</span>
          </p>
        </div>
      </div>
